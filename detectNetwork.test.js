...
/*  it('Throws an error so it fails', function() {
  ...
  });        //commented to make the tests pass*/
...
describe('Diner\'s Club', function() {
  ...
  it('has a prefix of 38 and a length of 14', function() {
    //throw new Error('Delete me!');   commented to pass the tests
...
describe('Discover', function() {
  ...
  for(var prefix=644; prefix<=649; prefix++) {
	(function(prefix) {
	  it('has a prefix of '+prefix+' and a length of 16', function() {
		expect(detectNetwork(prefix+'0123456789012')).to.equal('Discover');  
	  });
	  it('has a prefix of '+prefix+' and a length of 19', function() {
		expect(detectNetwork(prefix+'0123456789012345')).to.equal('Discover');  
	  });
	})(prefix)
  }
...
describe('Maestro', function() {
  ...
  for(var i=0; i<prefixs.length; i++) {
	...
	for(var len=12; len<=19; len++) {
      (function(prefixs, i, len, main) {
		it('has a prefix of '+ prefixs[i] +' and a length of' + len, function() {
		  expect(detectNetwork(prefixs[i]+main)).to.equal('Maestro');
		});
	  })(prefixs,  i, len, main)
	  main = main + '1';
	}		
